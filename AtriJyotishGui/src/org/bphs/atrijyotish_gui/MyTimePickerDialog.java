...
** File:       : MyTimePickerDialog.cpp
** Description : Time picker with seconds (Copied from Ivan Kovac)
**
...
public class MyTimePickerDialog extends AlertDialog implements OnClickListener, 
    ...
    public MyTimePickerDialog(Context context,
        ...
        //setButton(context.getText(R.string.time_set), this);    // TODO 1st arg 0 added
        ...
        mTimePicker = (TimePicker) view.findViewById(org.bphs.atrijyotish_gui.R.id.timePicker);
